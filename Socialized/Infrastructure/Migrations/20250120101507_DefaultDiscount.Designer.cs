...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250120101507_DefaultDiscount")]
    partial class DefaultDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.FilterWord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.HistoryGS", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.MediaGS", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.UnitGS", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Statistics.CommentStatistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Statistics.DayStatistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("GetDirectionsClicks")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PhoneCallClicks")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TextMessageClicks")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Statistics.OnlineFollowers", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("OnlineFollowers");
                });

            modelBuilder.Entity("Domain.Statistics.PostStatistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Statistics.StoryStatistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.MediaGS", b =>
                {
                    b.HasOne("Domain.GettingSubscribes.UnitGS", "Unit")
                        .WithMany("Medias")
            ...
            modelBuilder.Entity("Domain.GettingSubscribes.UnitGS", b =>
                {
                    b.HasOne("Domain.GettingSubscribes.TaskData", "Data")
                        .WithMany("Units")
            ...
            modelBuilder.Entity("Domain.Statistics.CommentStatistics", b =>
                {
                    b.HasOne("Domain.Statistics.PostStatistics", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Statistics.DayStatistics", b =>
                {
                    b.HasOne("Domain.InstagramAccounts.BusinessAccount", "Account")
                        .WithMany("Statistics")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
